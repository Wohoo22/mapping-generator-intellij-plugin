...
import com.github2.input.classnamesuggestion.ClassNameSuggestion;
import com.github2.input.classnamesuggestion.dropdowntextsuggestion.SuggestionDropDownDecorator;
import com.github2.input.classnamesuggestion.dropdowntextsuggestion.suggestionclient.impl.TextComponentSuggestionClient;
...
public class JavaToJavaInput extends DialogWrapper {
    private final Project project;
    private final GlobalSearchScope globalSearchScope;

    public JavaToJavaInput(Project project, GlobalSearchScope globalSearchScope) {
        super(true);
