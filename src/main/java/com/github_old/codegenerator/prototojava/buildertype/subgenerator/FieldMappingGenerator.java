package com.github_old.codegenerator.prototojava.buildertype.subgenerator;
...
public class FieldMappingGenerator {
    public String generateMappingCode(ElementNode elementToSet, ElementNode elementToGet, String sourceToGet, String indent,
        ...
        if (DataTypeNodeUtils.qualifiedNameEqual(elementToSet.getDataTypeNode(), elementToGet.getDataTypeNode())) {
            ...
            result.append(JavaCommandUtils.dotField(elementToSet.getName(), getter));
        }
        // if type == enum
            ...
            result.append(JavaCommandUtils.dotField(elementToSet.getName(), enumConversion));
        }
        // if type == map
        ...
        // if type == object
            ...
            result.append(JavaCommandUtils.dotField(elementToSet.getName(), valueToSet));
        }
        // if type == list
            ...
            String listSource = JavaCommandUtils.generateProtoListGetter(sourceToGet, elementToGet.getName());
