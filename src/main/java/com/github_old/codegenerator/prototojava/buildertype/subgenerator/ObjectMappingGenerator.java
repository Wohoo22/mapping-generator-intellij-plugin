...
public class ObjectMappingGenerator {
    public String generateMappingCode(List<ElementNode> elementsToSet, List<ElementNode> elementsToGet,
        ...
        // open the builder
        result.append(indent).append(JavaCommandUtils.openObjectBuilder(objectToSetQualifiedName));
        ...
        // close the builder
        result.append(indent).append(JavaCommandUtils.closeObjectBuilder());
